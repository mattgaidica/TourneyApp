...
def display_schedule_table(date, games, bootcamp):
    ...
    # Helper function for winner cell
    def winner_html(game):
        return f'<div class="winner-cell">Winner: {game["winner"]}</div>' if show_winners else ''
    
    # Build HTML without any newlines or extra spaces
    html = f'<div class="event-container"><div class="date-header">{date}</div><div class="game-content"><div class="time-slots"><div class="time-slot">1600</div><div class="time-slot">1630</div></div><div class="fields-grid"><div class="field-column"><div class="field-label">Field A</div><div class="team-info">{games[0]["teams"]}</div>{winner_html(games[0])}</div><div class="field-column"><div class="field-label">Field B</div><div class="team-info">{games[1]["teams"]}</div>{winner_html(games[1])}</div><div class="field-column"><div class="field-label">Field A</div><div class="team-info">{games[2]["teams"]}</div>{winner_html(games[2])}</div><div class="field-column"><div class="field-label">Field B</div><div class="team-info">{games[3]["teams"]}</div>{winner_html(games[3])}</div></div><div class="bootcamp-section"><div class="bootcamp-header">BOOTCAMP</div><div class="bootcamp-grid"><div class="bootcamp-info">{bootcamp["games1_2"]}</div><div class="bootcamp-info">{bootcamp["games3_4"]}</div></div></div></div></div>'
