...
def display_finals_table(date, games):
    ...
    # Add time element for sudden death with field colors
    st.markdown('<div class="time-slot" style="text-align: center; width: 100%; background: linear-gradient(90deg, var(--field-a-bg) 0%, var(--field-b-bg) 100%);">1620</div>', unsafe_allow_html=True)
